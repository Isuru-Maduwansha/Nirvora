...
function Packages() {
  ...
  return (
    ...
    >
      <div
        id="top"
        className="w-full flex lg:flex-row flex-col justify-between items-center lg:gap-20 gap-5"
      >
        <div>
          <h1
            dta-aos="zoom-in"
        ...
        <div className="flex flex-col justify-between items-start gap-7">
          ...
          >
            ...
            magni sapiente totam nobis nemo quaerat veritatis at iste inventore
            illo?
          </p>
          <hr
            data-aos="zoom-in"
          ...
          {tourpackages.map((item, index) => (
            ...
            >
              <div
                ...
                className="bg-cover bg-center h-75 w-full rounded-t-md relative"
              >

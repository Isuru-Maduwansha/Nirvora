    ...
    >
      <div className="flex flex-col justify-center items-start">
        ...
        <img
          ...
          data-aos-delay="200"
          src={aboutimg2}
          className="rounded-md w-[40%] border-10 border-white -mt-37.5 -ml-7.5 -rotate-2"
          alt=""
        />
      </div>
      <div className="flex flex-col gap-5">
        ...
        >
          ...
          vel exercitationem saepe facere harum! Velit aliquam provident
          delectus doloremque ducimus.
        </p>
